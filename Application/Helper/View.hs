    ...
    <div class="relative flex items-center justify-between h-16">
      ...
      <div class="flex lg:hidden">
        ...
        <button x-on:click="mobileMenu = !mobileMenu" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-expanded="false">
          ...
          -->
          <svg x-bind:class="{'block': mobileMenu, 'hidden': !mobileMenu}" class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
      ...
      <div class="hidden lg:block lg:ml-4">
        <div class="flex items-center">
          ...
          <div class="ml-4 relative flex-shrink-0">
            <div>
              <button class="bg-gray-800 rounded-full flex text-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu" aria-haspopup="true">
